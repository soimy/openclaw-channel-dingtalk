...
import type { DingTalkConfig, DocInfo, ChannelLogSink } from "./types";

const DINGTALK_API = "https://api.dingtalk.com";

async function buildHeaders(config: DingTalkConfig, log?: ChannelLogSink): Promise<Record<string, string>> {
