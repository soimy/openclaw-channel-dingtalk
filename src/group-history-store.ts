...
// @technical-debt
// OpenClaw's framework-level session history does not yet expose the filtered
// retrieval this channel needs for `/summary` (by conversation, sender,
// mention, and time window), so the channel keeps a local rolling window plus
// archived segments for now.
